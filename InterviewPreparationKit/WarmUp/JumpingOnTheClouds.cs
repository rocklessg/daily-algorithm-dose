...
//jump on any cumulus cloud having a number that is equal to the number of the current 
//cloud plus or . The player must avoid the thunderheads. Determine the minimum number 
//of jumps it will take to jump from the starting postion to the last cloud.It is always
...
//follow these two paths:  or.The first path takes  jumps while the second takes.Return.
